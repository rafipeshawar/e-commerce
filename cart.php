...
<head>
	<title>PD HARUM JAYA - Keranjang Saya</title>
	<!-- for-mobile-apps -->
...
<body>
	...
	<div class="checkout">
		<div class="container">
			<h2>Dalam keranjangmu ada : <span style="color:orange"><?php echo $itungtrans3 ?> Barang</span></h2>
		...
		<div class="checkout-left">
			<div class="checkout-left-basket">
				...
				<ul>
					...
					?>
					<li>Total (inc. 150k Ongkir sejabodatabek)<i> - </i> <span>Rp<?php echo number_format($subtotal) ?></span></li>
				</ul>
			</div>
