...
<head>
	<title>PD HARUM JAYA - Checkout</title>
	<!-- for-mobile-apps -->
...
<body>
	...
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?= $_SESSION['name'] ?> telah membeli <?php echo $itungtrans3 ?> barang di PD HARUM JAYA</span></h1>
			<br>
		...
		<br>
		<center>
			<h2>Total harga yang tertera di atas sudah termasuk ongkos kirim sebesar Rp150.000</h2>
