...
<head>
    ...
    <title>Kelola Pesanan - PD HARUM JAYA</title>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php
                                                        ...
                                                        // $cekkonfirmasipembayarantf = mysqli_query($conn,"select buktitf from konfirmasi where orderid='$orders'");
                                                        $cekroww = mysqli_num_rows($cekkonfirmasipembayaran);
                                                        // $cekrowww = mysqli_fetch_array($cekkonfirmasipembayarantf);
                                                        ...
                                                        ?>
                                                        <!-- <td><a href="../images/<?php echo $cekkonfirmasipembayarantf ?>"target="">Hubungi via WhatsApp </a> </td> -->
                                                    </td>
                                                </tr>
                                            <?php
                                            }
