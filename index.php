...
<body>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-2">
					...
					<h1>Create Your Space<br>With New Style!</h1>
					<p>PD Harum Jaya Indonesia, pusat perlengkapan, kebutuhan rumah tangga dan gaya hidup terlengkap.</p>
					<a href="#produk" class="btn">Check Sekarang! &#8594;</a>
				</div>
				<div class="col-2">
	...
	<!-- top-brands -->
	<div class="top-brands" id="produk">
		<div class="container">
			<h2>Produk Kami</h2>
													...
													<figure>
														<div class="snipcart-item block">
															<div class="snipcart-thumb">
																<a href="product.php?idproduk=<?php echo $p['idproduk'] ?>"><img title=" " alt=" " src="<?php echo $p['gambar'] ?>" width="102px" height="200px" /></a>
