...
if (isset($_POST['confirm'])) {
	...
	$nama = $_POST['nama'];
	$metode = $_POST['metode'];
	$bukti_tf = $_FILES["bukti_transfer"]["name"];
	$tanggal = $_POST['tanggal'];
	$image_temp_location = $_FILES['bukti_transfer']['tmp_name'];

	move_uploaded_file($image_temp_location, './images/' . $bukti_tf);

	$kon = mysqli_query($conn, "insert into konfirmasi (orderid, userid, payment, namarekening, buktitf, tglbayar) 
		values('$idorder','$userid','$metode','$nama','$bukti_tf','$tanggal')");
	if ($kon) {
...
<head>
	<title>PD HARUM JAYA - Konfirmasi Pembayaran</title>
	<!-- for-mobile-apps -->
	...
	<div class="register">
		<div class="container">
			...
			<div class="login-form-grids">
				<h3>Kode Order</h3>
				<form method="post" enctype="multipart/form-data" <strong>
					...
					<input type="file" name="bukti_transfer"></input>
					<h6>Tanggal Bayar</h6>
